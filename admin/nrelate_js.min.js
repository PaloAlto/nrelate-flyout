...
(d=document.createElement("iframe"),d.id=e,d.src=c.whats_this_url||b.whats_this_url,d.style.width="100%",d.style.height="260px",d.style.border="0px",d.setAttribute("border","0"),document.body.appendChild(d));d={};c.whats_this_width&&(d.width=c.whats_this_width);c.whats_this_height&&(d.height=c.whats_this_height);(new n(e,d)).show();g.prevent_default(a)})},ucs:function(a,b,c){var d,e,g,h,f=this;if(!c.did||0==(h=this.xgebcn("nr_link","a",a)).length)return!1;this.tuc(a,b,c);b=0;for(d=h.length;b<d;b++)e=
